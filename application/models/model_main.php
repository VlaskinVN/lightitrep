<?php
    ...
    {
        // получение числа с арабского в римское
        function number_to_roman($value)
        {
            ...
            $table = array(
                ...
                9 => "IX", 5 => "V", 4 => "IV", 1 => "I"); // массив возможных значений
        ...
        // получение числа с риского в арабское
            ...
            while($roman){
                foreach ($romans as $key => $value) {
                    ...
                    while (strpos($roman, $key) === 0) {    
                        if (!preg_replace("~($key){4,}~", '', $roman)){ // проверка на повторяемость значений
                            return "error";
                        }                   
